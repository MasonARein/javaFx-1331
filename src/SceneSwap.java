...
//        error.showAndWait();
    ...
    private void createOnScene(Stage stage) {
        if(ON_SCENE == null) {
            VBox box = new VBox();
            ImageView bulb = new ImageView("imageSceneSwap/On_Bulb.png");
            ImageView lightSwitch = new ImageView("imageSceneSwap/LS_On.jpg");
    ...
    private void createOffScene(Stage stage) {
        if(OFF_SCENE == null) {
            VBox box = new VBox();
            ImageView bulb = new ImageView("imageSceneSwap/Off_Bulb.png");
            ImageView lightSwitch = new ImageView("imageSceneSwap/LS_Off.jpg");
            lightSwitch.setOnMouseClicked(e -> {
